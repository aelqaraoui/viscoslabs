...
function Header(props) {
  ...
  return (
    ...
    <Flex>
        <Text>ViscosLabs</Text>
        <Spacer />

        <Button onClick={props.callbackLoanListings} mx={3}>Loan Listings</Button>
        <Button onClick={props.callbackCreateLoan} mx={3}>Create Loan</Button>
